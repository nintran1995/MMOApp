...
namespace ZChangerMMO.Licensing.Licensing
{
    ...
    /// </summary>
    internal static class Lic
    {
        /// <summary>
        /// Creates a new builder for creating signed license objects.
        /// </summary>
        internal static IBuilder_Signer Builder => new LicBuilder();

        /// <summary>
        /// Creates a new key generator for creating private / public key pairs.
        /// </summary>
        internal static IKeyGenerator KeyGenerator => new LicKeyGenerator();

        /// <summary>
        /// Creates a new verifier for verify license strings.
        /// </summary>
        internal static IVerifier_Signer Verifier => new LicVerifier();
    }
