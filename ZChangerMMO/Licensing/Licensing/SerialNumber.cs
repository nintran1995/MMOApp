...
namespace ZChangerMMO.Licensing.Licensing
{
    ...
    /// </summary>
    internal static class SerialNumber
    {
        ...
        /// </returns>
        internal static string Create(string threeLetterApplicationCode)
        {
        ...
        /// </returns>
        internal static string CreateEmpty(string threeLetterApplicationCode)
        {
            if (threeLetterApplicationCode == null)
        ...
        /// </returns>
        internal static bool IsApplicationCodeValid(string serialNumber, string applicationCode)
        {
