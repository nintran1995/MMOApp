...
namespace ZChangerMMO.Licensing.Licensing
{
    ...
    {        
        ...
        /// </param>
        internal static void SetComputerCharacteristics(IComputerCharacteristics computerCharacteristics)
        {
        ...
        /// </exception>
        internal static string ForCurrentComputer()
        {
        ...
        /// </returns>
        internal static bool IsValidForCurrentComputer(string hardwareIdentifier)
        {
        ...
        /// </exception>
        internal static bool ArePartialEqual(string hardwareIdentifier1, string hardwareIdentifier2)
        {
