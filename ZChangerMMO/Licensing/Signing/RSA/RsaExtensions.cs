...
using ZChangerMMO.Licensing.Signing.RSA;
...
namespace ZChangerMMO.Licensing.Licensing
{
    internal static class RsaExtensions
    {
        ...
        /// </returns>
        internal static IBuilder_HardwareIdentifier WithRsaPrivateKey(this IBuilder_Signer signer, string base64EncodedCsbBlobKey)
        {
        ...
        /// The next fluent API object.
        /// </returns>
        internal static IBuilder_HardwareIdentifier WithRsaPrivateKey(this IBuilder_Signer signer, byte[] csbBlobKey)
        {
        ...
        /// The next fluent API object.
        /// </returns>
        internal static IBuilder_HardwareIdentifier WithRsaPrivateKey(this IBuilder_Signer signer, RSAParameters rsaParameters)
        {
        ...
        /// The next fluent API object.
        /// </returns>
        internal static IVerifier_ApplicationCode WithRsaPublicKey(this IVerifier_Signer signer, string base64EncodedCsbBlobKey)
        {
        ...
        /// The next fluent API object.
        /// </returns>
        internal static IVerifier_ApplicationCode WithRsaPublicKey(this IVerifier_Signer signer, byte[] csbBlobKey)
        {
            var rsaSigner = new RsaSigner(csbBlobKey);
            signer.WithSigner(rsaSigner);
        ...
        /// The next fluent API object.
        /// </returns>
        internal static IVerifier_ApplicationCode WithRsaPublicKey(this IVerifier_Signer signer, RSAParameters rsaParameters)
        {
            var rsaSigner = new RsaSigner(rsaParameters);
            signer.WithSigner(rsaSigner);
            return signer as IVerifier_ApplicationCode;
        ...
        /// </returns>
        internal static SigningKeyPair GenerateRsaKeyPair(this IKeyGenerator keyGenerator)
        {
